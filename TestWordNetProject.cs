...
namespace wordNet_project
{
    class TestWordNetProject
    {
        ...
        public static void CompletTest_using_SCA()
        {
            ...
            //----------------------------------------------------------
            flag = Testing_complet(false, synsets, hypernyms, relationQueries, outcastQueries, Output1, Output2, "Case3_82K_300K_5000RQ");
 ...
 String TestcaseName)
    ...
    String TestcaseName)
        ...
        public static bool Testing_complet(bool isoutcastQueries, List<string> synsets, List<string> hypernyms,
List<string> relationQueries, List<string> outcastQueries, List<string> Output1, List<string> Output2,
String TestcaseName)
        {
            bool flag = true;
